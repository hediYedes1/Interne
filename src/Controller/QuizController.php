...
public function submitQuizFront(Request $request, TesttechniqueRepository $testRepo, EntityManagerInterface $em): JsonResponse
{
    try {
        $data = json_decode($request->getContent(), true) ?: $request->request->all();
        ...
        return new JsonResponse([
            ...
            'message' => 'Quiz soumis avec succès. Résultat: ' . $statut->value
        ]);
