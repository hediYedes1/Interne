...
#[ORM\Entity]
class Affectation_interview
{

    #[ORM\Id]
        #[ORM\ManyToOne(targetEntity: Interview::class, inversedBy: "affectation_interviews")]
    #[ORM\JoinColumn(name: 'ID_INTERVIEW', referencedColumnName: 'ID_INTERVIEW', onDelete: 'CASCADE')]
    private Interview $ID_INTERVIEW;

    #[ORM\Id]
        #[ORM\ManyToOne(targetEntity: Utilisateur::class, inversedBy: "affectation_interviews")]
